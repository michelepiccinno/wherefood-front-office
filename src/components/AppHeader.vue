    ...
    methods: {
        ...
        addToCart(product) {
            ...
            if (cartProduct) {
                ...
                product.isAdded = true; // Imposta il flag isAdded a true per questo prodotto
            }
        ...
        removeFromCart(productId) {
            ...
            if (index !== -1) {
                ...
                // Imposta il flag isAdded a false per questo prodotto
...
<template>
  <div class="nav d-flex justify-content-between align-items-center">
    ...
    <div>
      ...
      <div class="offcanvas offcanvas-end custom-offcanvas" style="width: 600px;" :class="{ 'show': isCartOpen }" id="cartOffcanvas" tabindex="-1">
        ...
        <div class="offcanvas-body">
          ...
          <div class="EmptyCart" v-if="store.cartItems.length === 0">Il carrello è vuoto</div>
        </div>
      </div>
    </div>
  </div>
